  ...
  opacity: 1;
	...
	<body>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/re.jpg);">
				<div class="desc">
					<div class="container">
						<div class="row">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Register Form</h3>
						<p>!Register !!! now  and  travel  whole world with us!</p>
					</div>
				</div>
			</div>
			<div>
			<form method="post" action="save.jsp" style="max-width:1000px;margin:auto">
