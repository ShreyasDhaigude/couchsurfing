	...
	<body>
		...
		<div id="fh5co-tours" class="fh5co-section-gray">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>bookings</h3>
						<p>!!!this is your Flight bookings!!!</p>
					</div>
				</div>
			</div>
			<div>
			...
			
			{
		    	...
		    	String q="select * from flight2 where rid='"+rid+"'";
		    	 ...
		    	 while(rs.next())
		    	    {
		    	        ...
		    	        <td><a href="deleteflight.jsp?id=<%=id %>"><button type="button" class="btn btn-danger">Delete</button></a>
		    	        <a href="updateFlight.jsp?id=<%=id %>"><button type="button" class="btn btn-success">Update</button></a>
		    	        </td>
		    	        <td><a href="pay.jsp"><button type="button" class="btn btn-primary">Pay</button></a>
		    	        </td>
