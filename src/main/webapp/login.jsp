...
<body translate="no" style="overflow: initial;">
    ...
    <div class="modal">
        <div class="modal-container">
            ...
            <form method="post" action="login2.jsp">
                ...
                <p class="modal-desc">couchsurfing website login for more information.!</p>
                ...
                <div class="modal-buttons">
                    <a href="forgotPass.jsp" class="">Forgot your password?</a>
                    <button class="input-button">Login</button>
                    
                </div>
                <p class="sign-up">Don't have an account? <a href="registration.jsp">Sign up now</a></p>
                </form>
            </div>
            
            <div class="modal-right">
                <img src="images/login..jpg" alt="Girl in a jacket" width="100" height="200">
            </div>
