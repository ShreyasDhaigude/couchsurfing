								  ...
								  <!-- Nav tabs -->
								   ...
								   <div class="tab-content">
									 ...
									 <div role="tabpanel" class="tab-pane active" id="hotels">
									 	 <form method="post" action="packagesave.jsp">
									 	...
									 	<div class="row">
											...
											<div class="col-sm-12 mt">
									           ...
									           <input type="text" name="state" id="" class="form-control form-control-lg custom-form-control" placeholder="state">
											...
											<div class="col-sm-12 mt">
												<section>
													<label for="class">packages:</label>
											...
											<div class="col-xs-12">
												<input type="submit" class="btn btn-primary btn-block" value="packages Booking">
											</div>
										</div>
										</form>
									 </div>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="images/place-1.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								...
								<span class="price">Rs.130000</span>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="images/place-3.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								...
								<span class="price">Rs.100000</span>
								<a class="btn btn-primary btn-outline" href="#">Book Now <i class="icon-arrow-right22"></i></a>
							</div>
						</div>
					</div>
