	...
	<body>
		...
		<div id="fh5co-tours" class="fh5co-section-gray">
			...
			
			{
		    	...
		    	String q="select * from car where rid='"+rid+"'";
		    	 ...
		    	 while(rs.next())
		    	    {
		    	        ...
		    	        <td><a href="deletecar.jsp?id=<%=id %>"><button type="button" class="btn btn-danger">Delete</button></a>
		    	        <a href="updateCar.jsp?id=<%=id %>"><button type="button" class="btn btn-success">Update</button></a>
		    	        
		    	      </tr>
		    	      <td><a href="payc.jsp"><button type="button" class="btn btn-primary">Pay</button></a>
		    	        </td>
