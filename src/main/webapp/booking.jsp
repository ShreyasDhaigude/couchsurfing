			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>bookings</h3>
						<p>!!!this is your Registration  bookings!!!</p>
					</div>
				</div>
			</div>
			<div>
		    	 ...
		    	 while(rs.next())
		    	    {
		    	        ...
		    	        <td><%=Name %></td>
		    	        <td><%=email %></td>
		    	        <td><a href="delete.jsp?rid=<%=id %>"><button type="button" class="btn btn-danger">Delete</button></a>
		    	        <a href="update.jsp?rid=<%=id %>"><button type="button" class="btn btn-success">Update</button></a>
