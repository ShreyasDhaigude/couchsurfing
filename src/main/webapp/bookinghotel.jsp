		...
		<div id="fh5co-tours" class="fh5co-section-gray">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>bookings</h3>
						<p>!!!this is your Hotel bookings!!!</p>
					</div>
				</div>
			</div>
			<div>
			...
			
			{
               Class.forName("com.mysql.cj.jdbc.Driver");
		    	...
		    	String q="select * from hotel where rid='"+rid+"'";
		    	 ...
		    	 while(rs.next())
	    	    	...
	    	    	session.setAttribute("a",adult);
		    	        ...
		    	        <td><%=room %></td>		    	        
		    	         <td><%=adult %></td>
		    	         <td><%=children %></td>	    	        
		    	        <td><a href="deletehotel.jsp?id=<%=id %>"><button type="button" class="btn btn-danger">Delete</button></a>
		    	        <a href="updatehotel.jsp?id=<%=id %>"><button type="button" class="btn btn-success">Update</button></a>
		    	        
		    	      </tr>
		    	      <td><a href="payh.jsp"><button type="button" class="btn btn-primary">Pay</button></a>
		    	        </td>
